...
class TestHBNBCommand_exit(unittest.TestCase):
    """testing exit HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """testing destroy using HBNB command interpreter."""
    ...
    def test_destroy_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            _obj = storage.all()["State.{}".format(testID)]
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            _obj = storage.all()["BaseModel.{}".format(testID)]
            command = "destroy BaseModel {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(_obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            _obj = storage.all()["User.{}".format(testID)]
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            _obj = storage.all()["City.{}".format(testID)]
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            _obj = storage.all()["Amenity.{}".format(testID)]
            command = "show Amenity {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(_obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            _obj = storage.all()["Place.{}".format(testID)]
            command = "show Place {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertNotIn(_obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            _obj = storage.all()["Review.{}".format(testID)]
...
class TestHBNBCommand_update(unittest.TestCase):
    """update test using the HBNB command interpreter."""
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """prompt test for HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """testing HBNB command interpreter show method"""
    ...
    def test_show_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            command = "show User {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(command))
            self.assertEqual(_obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_help(unittest.TestCase):
    """testing HBNB command interpreter help messages."""

    def test_help_EOF(self):
        _help = "exit the program EOF signal."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_show(self):
        _help = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
             "Show the string variant of a class instance of"
             " a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        _help = ("Usage: all or all <class> or <class>.all()\n        "
             "Show string variants of all instances of a given class"
             ".\n        If class is not specified, displays all instantiated "
             "objects.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_count(self):
        _help = ("Use: count <class> or <class>.count()\n        "
...
class TestHBNBCommand_count(unittest.TestCase):
    """testing HBNB comand interpreter count method."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """testing HBNB command interpreter all."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """testing HBNB command interpreter create method."""
